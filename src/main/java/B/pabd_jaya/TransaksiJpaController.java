...
import B.pabd_jaya.exceptions.IllegalOrphanException;
import B.pabd_jaya.exceptions.NonexistentEntityException;
import B.pabd_jaya.exceptions.PreexistingEntityException;
...
public class TransaksiJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("B_pabd_jaya_jar_0.0.1-SNAPSHOTPU");
